...
export const WORKFLOW_STRICT_GATE_RECEIPT_SCHEMA = "workflow-strict-gate-receipt:v1";
export const WORKFLOW_LEGACY_FINAL_GATE_RECEIPT_SCHEMA = "workflow-final-gate-receipt:v1";
export const WORKFLOW_FINAL_GATE_RECEIPT_SCHEMA = "workflow-final-gate-receipt:v2";
...
function strictGateCheck(gate, storyId, outputCheck, deliveryCheck) {
  ...
  if (gate && !intermediate && !legacyFinal) {
  ...
  if (
    ...
    issues.push("final v2 gate receipt lacks a complete terminal workflow proof");
  }
