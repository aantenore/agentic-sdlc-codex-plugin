...
const LABELS = Object.freeze({
  en: Object.freeze({
    ...
    rootNext: "Usual order: requirement -> story -> work brief/output -> autonomy for this delivery -> one task start -> implement/test -> delivery.",
  ...
  it: Object.freeze({
    ...
    rootNext: "Ordine abituale: requisito -> story -> accordo di lavoro/output -> autonomia per questa consegna -> un solo avvio attività -> implementazione/test -> consegna.",
