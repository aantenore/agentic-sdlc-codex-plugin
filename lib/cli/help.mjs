...
const LABELS = Object.freeze({
  en: Object.freeze({
    ...
    rootNext: "Usual order: requirement -> story -> work brief/output -> autonomy -> story workflow start -> one task start -> complete each phase and advance -> validation gate -> enter release -> delivery/release evidence -> final lifecycle gate.",
  ...
  it: Object.freeze({
    ...
    rootNext: "Ordine abituale: requisito -> story -> accordo di lavoro/output -> autonomia -> avvio workflow della story -> un solo avvio attività -> completa e avanza ogni fase -> gate di validazione -> ingresso in release -> consegna/prove di release -> gate lifecycle finale.",
