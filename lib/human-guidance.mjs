...
const CATALOG = Object.freeze({
  en: Object.freeze({
    ...
    "delivery.proposal.boundary.local": "This is for project {project}. The destination is the local folder {target_root}. I may change only {write_paths}, and the smoke test runs from {smoke_cwd}.",
  ...
  it: Object.freeze({
    ...
    "delivery.proposal.boundary.local": "Questa scelta riguarda il progetto {project}. La destinazione è la cartella locale {target_root}. Posso modificare soltanto {write_paths} e lo smoke test parte da {smoke_cwd}.",
