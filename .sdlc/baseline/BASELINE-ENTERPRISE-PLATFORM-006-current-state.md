...
## Summary
Refreshed the same agreed evidence set after final review: Windows command resolution now rejects relative, project-local, device, UNC, SUBST, and mapped-drive aliases while portable RTK expectations remain explicit.
...
- docs/getting-started.md: Getting Started > Choose A Starting Request > Conversation And Control Have Different Jobs > The Delivery Journey > What You Approve > Autonomy Is Explained Before You Choose > New Requirement And New Pull Request > Continue An Existing Pull Request > Local-Only Result Or Release > Local, Repository, And Production Are Separate > When The Workflow Pauses > What A Finished Result Means
...
- docs/getting-started.md: Getting Started; sections Getting Started > Choose A Starting Request > Conversation And Control Have Different Jobs > The Delivery Journey > What You Approve > Autonomy Is Explained Before You Choose > New Requirement And New Pull Request > Continue An Existing Pull Request > Local-Only Result Or Release > Local, Repository, And Production Are Separate > When The Workflow Pauses > What A Finished Result Means; evidence a6f597f86cfc5e691eed5405a77165cce1939c7ba1f353e684cebcdaa7c1f3f1
