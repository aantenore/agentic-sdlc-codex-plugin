...
7. Run `gate check --story <id> --strict`.
...
5. Resolve conflicts by splitting stories, transferring claims, or using phase locks.
6. Run project-wide `gate check --scope all --strict` before release.
