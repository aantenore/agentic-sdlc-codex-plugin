...
A normal local, read-only assessment has exactly two logical user checkpoints. Every question explains what is being asked, why, what the answer authorizes and excludes, and gives Italian and English response examples.
